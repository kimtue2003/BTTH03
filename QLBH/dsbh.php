...
<head>
    ...
    <title>Danh Sách Bài Hát Yêu Thích</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-2 bg-danger">
                ...
                <div class="sidebar mt-4">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Danh Sách Bài Hát Yêu Thích </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="./theloainhac.php">Thể Loại Nhạc</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-9 bg-light">
                ...
                <div>
                   <a href="./thembaihat.php" class="btn btn-primary">
                ...
                <div class="mt-2">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $list_sql = "SELECT * FROM BAIHAT ORDER BY tenBaiHat, caSi";
                            ...
                            <tr>
                                 ...
                                 <td><?php echo $r['idTheLoai']; ?></td>
                                 <td>
                                     <a href="Infor.php?sid=<?php echo $r['id']; ?>" style="color:orangered"><i class="bi bi-eye-fill ms-2 function"></i></a>
                                     <a href="edit.php?sid=<?php echo $r['id']; ?>" style="color:yellow"><i class="bi bi-pencil-square function"></i></a>
                                     <a onclick="return confirm('Bạn có muốn bài hát này không?')" href="delete.php?sid=<?php echo $r['id']; ?>" style="color:blue"><i class="bi bi-trash-fill function"></i></a>
                                 </td>
                            </tr>
                            <?php
                            }
